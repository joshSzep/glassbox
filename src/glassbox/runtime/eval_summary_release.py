"""Release sign-off aggregation for eval reports."""
...
from glassbox.runtime import eval_summary_release_render
...
build_eval_release_signoff_summary = (
    eval_summary_release_render.build_eval_release_signoff_summary
)
