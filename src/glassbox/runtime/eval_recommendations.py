...
def recommend_eval_change_impact(
    ...
    *,
    ...
    matched_paths, coverage_audit_recommended, warnings = (
        _add_direct_path_recommendations(
    ...
    matched_owners, matched_capabilities = _add_rule_match_recommendations(
    ...
    _add_owner_derived_case_recommendations(
        cases=cases,
        matched_owners=matched_owners,
        case_reasons=case_reasons,
    )
    _add_capability_derived_case_recommendations(
        cases=cases,
        cases_by_id=cases_by_id,
    ...
    impacted_stages = _build_impacted_stages(
        cases_by_id=cases_by_id,
        capabilities_by_id=capabilities_by_id,
        case_reasons=case_reasons,
        matched_capabilities=matched_capabilities,
    )
    _add_stage_derived_profile_recommendations(
        profiles=profiles,
        impacted_stages=impacted_stages,
        profile_reasons=profile_reasons,
    )
    _add_fallback_profile_recommendations(
        normalized_paths=normalized_paths,
        profiles=profiles,
        case_reasons=case_reasons,
        profile_reasons=profile_reasons,
...
def _add_direct_path_recommendations(
    *,
    normalized_paths: list[str],
...
def _add_rule_match_recommendations(
    *,
...
def _add_owner_derived_case_recommendations(
    *,
    cases: list[EvalCase],
    matched_owners: _RuleTargetMatches,
    case_reasons: _RecommendationReasonMap,
...
def _add_capability_derived_case_recommendations(
    *,
    cases: list[EvalCase],
    cases_by_id: dict[str, EvalCase],
...
def _add_stage_derived_profile_recommendations(
    *,
    profiles: list[EvalProfileDefinition],
...
def _add_fallback_profile_recommendations(
    *,
    normalized_paths: list[str],
    profiles: list[EvalProfileDefinition],
    case_reasons: _RecommendationReasonMap,
