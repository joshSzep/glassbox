...
def _interactive_help_text(mode: str) -> str:
    lines = [
        ...
        "  /review queue inspect the ranked operator queue",
        "  /review next-actions show action-needed queue entries",
        ...
        "  /review maintenance inspect queue-linked maintenance checks",
