...
function renderComparedSessionCard(label, sessionLike) {
...
function renderCompareInspector(state) {
  ...
  return `<div class="session-compare-panel">
    ...
    <div class="selected-session-grid">
      ${renderComparedSessionCard("Selected session", state)}
      ${renderComparedSessionCard("Compared session", compareSession)}
      <div class="selected-session-item">
