...
import { groupPlanEntries } from "./verification-plan-format";
import {
  VerificationPlanEntryGroups,
  VerificationPlanSummaryEntries,
  VerificationRequirementsList,
  VerificationReviewLoopContext,
  VerificationSkippedChecks,
} from "./verification-plan-table";
  ...
  return (
    <Section title="Verification">
      <div className="grid gap-3">
        ...
        <VerificationPlanSummaryEntries entries={visiblePlanEntries} />
        <VerificationReviewLoopContext reviewLoop={reviewLoop} />
        <VerificationRequirementsList requirements={visibleRequirements} />
